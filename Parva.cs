...
namespace Parva {
  ...
  public class Parva {
    ...
    public static void Main (string[] args) {
      bool mergeErrors = false, execution = true, immediate = false, givecod = false;
      ...
      for (int i = 0; i < args.Length; i++) {
		...
		else if (args[i].ToLower().Equals("-c")) givecod = true;
      ...
      if (inputName == null) {
		...
		Console.WriteLine("-c produces the .cod file of the supplied .pav file");
