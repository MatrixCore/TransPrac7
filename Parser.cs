...
public class Parser {
	...
	public const int elseif_Sym = 22;
	...
	// pragmas
	public const int DebugOn_Sym = 48;
	public const int DebugOff_Sym = 49;
	public const int StackDump_Sym = 50;
	public const int HeapDump_Sym = 51;
	public const int TableDump_Sym = 52;
	public const int GiveCOD_Sym = 53;
	public const int NoGiveCOD_Sym = 54;
	public const int ShowWarning_Sym = 55;
	public const int NoWarning_Sym = 56;

	public const int maxT = 47;
	public const int _DebugOn = 48;
	public const int _DebugOff = 49;
	public const int _StackDump = 50;
	public const int _HeapDump = 51;
	public const int _TableDump = 52;
	public const int _GiveCOD = 53;
	public const int _NoGiveCOD = 54;
	public const int _ShowWarning = 55;
	public const int _NoWarning = 56;
