  ...
  public class Parva {
    ...
    public static void Main (string[] args) {
      ...
      for (int i = 0; i < args.Length; i++) {
		...
		else if (args[i].ToLower().Equals("-c")) Parser.givecod = true; // Completed Task 1
		else if (args[i].ToLower().Equals("-w")) Parser.warnings = false; // Task 1
      ...
      if (inputName == null) {
		...
		Console.WriteLine("-c produces the .cod file of the supplied .pav file");  // Completed Task 1
		Console.WriteLine("-w suppresses warning messages"); // Task 1
      ...
      if (Parser.givecod) PVM.ListCode(codeName, codeLength);  // Completed Task 1
