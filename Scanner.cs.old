...
public class Scanner {
	...
	// pragmas
	const int DebugOn_Sym = 48;
	const int DebugOff_Sym = 49;
	const int StackDump_Sym = 50;
	const int HeapDump_Sym = 51;
	const int TableDump_Sym = 52;
	const int GiveCOD_Sym = 53;
	const int NoGiveCOD_Sym = 54;
	const int ShowWarning_Sym = 55;
	const int NoWarning_Sym = 56;
	...
	static void CheckLiteral() {
		switch (t.val) {
			...
			case "elseif": t.kind = elseif_Sym; break;
	...
	static Token NextToken() {
		...
		switch (state) {
			...
			case 17:
				{ t.kind = GiveCOD_Sym; goto done; }
			case 18:
				{ t.kind = NoGiveCOD_Sym; goto done; }
			case 19:
				{ t.kind = ShowWarning_Sym; goto done; }
			case 20:
				{ t.kind = NoWarning_Sym; goto done; }
			case 21:
